...
This is not really achievable on a personal level and requires change in the current publication and research system.
What we can do on an individual researcher or research group level is 
...
You have to write a whole paper, develope the analysis, make all the decisions, all without ever collecting or seeing any data.
But this is exactly the point. This will allow you to get feedback on your research plan at a stage where you can still change things, without having to collect any additional data. 
Plus: A publication is almost guarranteed. 
:::
...
The concept of the estimand gives us a structure that helps being very specific about a hypothesis
This removes researchers degree of freedom during the readout, and encourages good scientific practices.
...
In practice for blinded studies, the study team is blinded until the day of the study readout. 
At that point, the statistical analysis and the relevant outputs have all been programmed, and only in rare cases are any changes to the programs allowed. 
The programs will then be executed, and the study team will prepare a short slide-deck for the upper management summarising the outcome of the study. 
Upper management then decides whether the study will be filed with the regulators, or not. 
