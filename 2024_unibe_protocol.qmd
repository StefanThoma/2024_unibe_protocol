...
-   Questionable research practices undermine trial integrity
    ...
    -   P-Hacking, e.g. adding covariates until p-value is significant (@tsang2025)
...
And then another researcher may come up and test the exact same hypothesis again, not just wasting resources but also increasing the chance of a false positive result, which would then likely be published.
...
**Move away from rewarding the most attention-grabbing findings**
...
This is not really achievable on a personal level and requires change in the current publication and research system. What we can do on an individual researcher or research group level is
...
Of course, the initial effort for this seems quite large.

You have to write a whole paper, develope the analysis, make all the decisions, all without ever collecting or seeing any data. But this is exactly the point. This will allow you to get feedback on your research plan at a stage where you can still change things, without having to collect any additional data. Plus: A publication is almost guarranteed.
:::
...
Protocols are required and an important part of setting up a clinical trial. They fill the role of a preregistration.
...
Protocols should be detailed enough to allow other researchers to recreate the study. With a proper protocol in place, you should be unable to pass off exploratory research as confirmatory research. Of course, the protocol can be changed, but this should be done in a transparent way, and the changes must be justified and approved by the regulators, especially for late-phase studies.
:::
...
The concept of the estimand gives us a structure that helps being very specific about a hypothesis This removes researchers degree of freedom during the readout, and encourages good scientific practices.
:::
...
In practice for blinded studies, the study team is blinded until the day of the study readout. At that point, the statistical analysis and the relevant outputs have all been programmed, and only in rare cases are any changes to the programs allowed. The programs will then be executed, and the study team will prepare a short slide-deck for the upper management summarising the outcome of the study. Upper management then decides whether the study will be filed with the regulators, or not.

In any case, the results of late-phase studies must be published.
:::

## Regulation - adversary?
...
Seemingly adversarial relationships between industry and regulators are actually beneficial for the patients.
...
-   Regulators ensure good scientific practice
    -   Same objective - to ensure the safety and efficacy of the drug

::: notes
Mention that having a signed-off protocol after data collection will help you stand up to anyone asking you to cut corners. It is your shield.
:::
